...
public enum ExceptionType {
    ...
    WRONG_TOKEN(HttpStatus.BAD_REQUEST, "유효한 token 값이 아닙니다."),
    WRONG_FORM_HEADER(HttpStatus.BAD_REQUEST, "요구되는 헤더양식에 부합하지 않습니다"),
    BAD_PASSWORD(HttpStatus.UNAUTHORIZED, "비밀번호는 영문자, 숫자, 특수문자를 포함하며 8자 이상이어야 합니다."),
    NOT_SOCIAL_LOGIN_USER(HttpStatus.UNAUTHORIZED, "소셜 로그인 사용자가 아닙니다."),
    ...
    POINT_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 포인트 정보를 찾을 수 없습니다."),
