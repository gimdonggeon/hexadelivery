...
public interface AdvertiseRepository extends JpaRepository<Advertise, Long> {
    ...
    Advertise findByStoreStoreIdAndAdvertiseStatus(Long storeId, AdvertiseStatus status);
    ...
    List<Store> findStoreByStoreCategoryAndStatus(Category category, AdvertiseStatus status);
